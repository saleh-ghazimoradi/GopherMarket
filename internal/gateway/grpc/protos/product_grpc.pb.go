...
const (
	...
	ProductService_AddProductImage_FullMethodName = "/protos.ProductService/AddProductImage"
	ProductService_SearchProducts_FullMethodName  = "/protos.ProductService/SearchProducts"
)
...
func (c *productServiceClient) AddProductImage(ctx context.Context, in *AddProductImageRequest, opts ...grpc.CallOption) (*ProductImageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedProductServiceServer) AddProductImage(context.Context, *AddProductImageRequest) (*ProductImageResponse, error) {
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/gateway/grpc/protos/product.proto",
}

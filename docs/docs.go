...
const docTemplate = `{
        ...
        "/v1/auth/google": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request data or invalid Google token",
                        "schema": {
                            "$ref": "#/definitions/helper.Response"
                        }
                    },
        ...
        "/v1/auth/reset-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request data or invalid/expired token",
                        "schema": {
                            "$ref": "#/definitions/helper.Response"
                        }
                    }
    ...
    "definitions": {
        ...
        "helper.PaginatedResponse": {
            ...
            "properties": {
                "meta": {
                    "$ref": "#/definitions/helper.PaginatedMeta"
                },
                "response": {
                    "$ref": "#/definitions/helper.Response"
                }
